...
<p align="center"><b>QA Automation & DevSecOps</b> · Ingeniería en Sistemas · Guatemala</p>

---

Automatizo pruebas con **Cypress** (E2E y API), construyo pipelines **DevSecOps** en **Jenkins** (SAST, SCA, escaneo de imágenes y DAST) y opero un **punto de venta en producción** sobre **DigitalOcean** con MySQL, Node.js y seguridad gestionada con Cloudflare y CrowdSec.
